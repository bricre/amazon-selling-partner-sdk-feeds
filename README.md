# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Feeds
...
```shell
composer require bricre/amazon-selling-partner-sdk-feeds
```
